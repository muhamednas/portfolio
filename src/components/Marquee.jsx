        ...
        <div style={{ display: "flex", gap: "2.5rem", width: "max-content", animation: "marqueeScroll 35s linear infinite" }}>
          {items.map((tech, i) => (
            <span key={i} style={{
              ...
              whiteSpace: "nowrap", padding: "0.2rem 0.8rem", borderRadius: "999px",
              ...
              <span style={{ width: "5px", height: "5px", borderRadius: "50%", background: "linear-gradient(135deg, #a78bfa, #22d3ee)", flexShrink: 0 }} />
              {tech}
            </span>
          ))}
        </div>
